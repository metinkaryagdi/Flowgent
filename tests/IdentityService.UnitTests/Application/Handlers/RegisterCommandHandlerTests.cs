...
public sealed class RegisterCommandHandlerTests
{
    ...
    public async Task Handle_Throws_WhenUserNameExists()
    {
        ...
        var handler = new RegisterCommandHandler(userRepository, hasher, unitOfWork, jwt, roleRepo, refreshRepo, mapper, options);
    ...
    public async Task Handle_CreatesUser_AssignsDefaultRole_AndReturnsTokens()
    {
        ...
        jwt.Generate(Arg.Any<User>(), Arg.Any<IReadOnlyList<string>>()).Returns(new JwtToken("access", DateTime.UtcNow.AddHours(1)));
