...
namespace BitirmeProject.StorageService.Api.Middleware;
...
public sealed class ExceptionHandlingMiddleware
{
    ...
    private static async Task WriteProblemDetailsAsync(HttpContext context, Exception exception)
    {
        var (statusCode, title, detail, extensions) = exception switch
        {
            ...
            DbUpdateConcurrencyException => (HttpStatusCode.Conflict, "Concurrency Conflict", "The storage record was updated by another request.", null),
