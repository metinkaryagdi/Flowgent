...
public sealed class OutboxRepository : IOutboxRepository
{
    ...
    public OutboxRepository(IssueDbContext dbContext)
    {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        // Step 1: Read candidate IDs (non-locking snapshot)
        ...
        // Step 2: Atomic UPDATE — only rows still Pending get claimed.
        // Concurrent workers targeting the same IDs will find Status != Pending and skip them.
        ...
        // Step 3: Return only rows this worker actually won
        return await _dbContext.OutboxMessages
            .Where(x => candidateIds.Contains(x.Id)
                        && x.LockId == lockId
