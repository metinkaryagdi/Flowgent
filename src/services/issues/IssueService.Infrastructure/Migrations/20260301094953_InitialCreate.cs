    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueAudits", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "IssueBoardItems",
                columns: table => new
                {
                    IssueId = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssueBoardItems", x => x.IssueId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueAttachments_FileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueAudits_IssueId",
                table: "IssueAudits",
                column: "IssueId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueBoardItems_ProjectId",
                table: "IssueBoardItems",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueBoardItems_SprintId",
                table: "IssueBoardItems",
                column: "SprintId");
